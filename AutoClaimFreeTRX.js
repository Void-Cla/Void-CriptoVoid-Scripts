...
// @grant        none
// @license MIT
// @name         Void Coin FreeTRX
// @namespace    https://greasyfork.org/en/scripts/497375-void-coin-freetrx
// @description  https://freetrx.in/?r=67569
// @description  https://greasyfork.org/en/users/1295753-sr-fox
...
(function() {
    ...
    $(document).ready(function() {
        ...
        setTimeout(function() {
            var playWithoutCaptchaButton = document.querySelector('#play_without_captchas_button');
            if (playWithoutCaptchaButton) {
                playWithoutCaptchaButton.click();
                console.log("Status: Clicado em PLAY WITHOUT CAPTCHA após 12 segundos.");
            } else {
                console.log("Botão PLAY WITHOUT CAPTCHA não encontrado após 12 segundos.");
            }
        }, 12000);
